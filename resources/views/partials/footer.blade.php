<footer class="main-footer">
    ...
    <strong>
        &copy; {{date('Y')}} Legend Logistics Company Limited All Rights Reserved. <a href="#" target="_blank"><strong style="color:#EE4323;">A Product by Doctor with africa</strong></a>
    </strong>
</footer>
