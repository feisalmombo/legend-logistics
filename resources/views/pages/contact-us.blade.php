...
>>>>>>> 038b854c518e0c5933f3586b80bd4ef63f21fdfc
                                        ...
                                        <div id="panel-120-0-0-1"
                                            class="so-panel widget widget_pw_opening_time opening-time panel-last-child"
                                            data-index="1">
                                            <div
                                                class="featured-widget panel-widget-style panel-widget-style-for-120-0-0-1">

                                                <div class="time-table">

                                                    <h3><span class="icon icons-ornament-left"></span>OPENING TIME<span
                                                            class="icon icons-ornament-right"></span></h3>
                                                ...
                                                <div role="form" class="wpcf7" id="wpcf7-f122-p120-o1" lang="en-US"
                                                    ...
                                                    <form action="#"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-12  col-md-4">
                                                                <span class="wpcf7-form-control-wrap last-name"><input
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-12  col-md-4">
                                                                <span class="wpcf7-form-control-wrap your-phone"><input
                                                                        type="tel" name="your-phone" value="" size="40"
