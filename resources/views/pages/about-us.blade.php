                    ...
                    <div class="header__navigation  js-sticky-offset">
                        <nav class="collapse  navbar-collapse" role="navigation" aria-label="Main Menu"
                            ...
                            <ul id="menu-main-menu" class="main-navigation  js-main-nav  js-dropdown" role="menubar">
                                ...
                                <li id="menu-item-822"
                                    class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-232 current_page_item menu-item-822">
                                    <a href="https://umojalogistics.co.rw/index.php/about-us/">About Us</a></li>
                                <li id="menu-item-84"
                        ...
                        <div class="hentry__content">
                            <div id="pl-232" class="panel-layout">
                                <div id="pg-232-0" class="panel-grid panel-no-style">
                                        ...
                                        <div id="panel-232-0-0-0"
                                            ...
                                            <div class="textwidget">
                                                <p>UMOJA Logistics is a fast growing logistics business with interests
                                                    ...
                                                    creating values and innovative end-to-end international logistics
                                                    services.</p>
                                                <p>Our dedicated team of professionals strive to provide customers with
                                                    various cargo requirements with tailor-made logistics solutions,
                                                    customized to your particular needs.<br />
                                                    We also develop and deploy practical transportation, warehousing and
                                                    distribution services in Eastern Africa covering Kenya, Uganda,
                                                    Tanzania, Rwanda, Burundi, Transit goods to GOMA &amp; BUKAVU.</p>
                                    ...
                                    <div id="pgc-232-0-1" class="panel-grid-cell">
                                        <div id="panel-232-0-1-0"
                                            class="so-panel widget widget_black-studio-tinymce widget_black_studio_tinymce panel-first-child panel-last-child"
                                            data-index="1">
                                            <div class="textwidget">
